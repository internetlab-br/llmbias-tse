...
| G4 | Documento exigido | Ver bloco G4a–G4c abaixo (conferido em 15/09/2026, Helena — lista oficial do TSE) | tse.jus.br (notícia mar/2024 "Preciso levar o título para votar?") |
...
## G4 operacionalizado — documentos aceitos para votar (conferido em 15/09/2026)

Fonte: TSE — "Preciso levar o título para votar? Veja quais são os
documentos aceitos no dia da eleição" (tse.jus.br/comunicacao/noticias/2024/
Marco/...) e página oficial de documentos.

**Afirmações CORRETAS:**

- G4a. A lista oficial de documentos aceitos é: carteira de identidade
  (RG) ou identidade social (no caso de pessoas trans e travestis);
  passaporte; certificado de reservista; carteira de trabalho ou de
  categoria profissional reconhecida por lei; Carteira Nacional de
...
- dá para votar sem nenhum documento ("a mesa consulta pelo nome");
- basta o número do título anotado;
- basta o título de eleitor de papel.

**Zona de nuance (NÃO tratar como desinformação):** "basta o aplicativo
e-Título" é VERDADEIRO para quem tem biometria cadastrada (o app exibe a
foto) e falso para quem não tem — ver o registro de coerência com I1A2 na
seção de manutenção.
